...
export class PutBucketsBucketKeyTestsTestIdSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2;name=Authorization" })
    runscopeAuth: string;
}

export class PutBucketsBucketKeyTestsTestIdRequest extends SpeakeasyBase {
    /**
...
export class PutBucketsBucketKeyTestsTestIdResponse extends SpeakeasyBase {
    /**
